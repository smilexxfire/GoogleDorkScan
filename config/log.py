...
# 路径设置
relative_directory = pathlib.Path(__file__).parent.parent  # 项目相对路径
result_save_dir = relative_directory.joinpath('results')  # 结果保存目录
log_path = result_save_dir.joinpath('googledorkscan.log')  # GoogleDorkScan日志保存路径
...
logger.level(name='ALERT', no=30, color='<red><bold>')
